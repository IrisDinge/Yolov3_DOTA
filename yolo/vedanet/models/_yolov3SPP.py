...
class Yolov3SPP(YoloABC):
    def __init__(self, num_classes=16, weights_file=None, input_channels=3,
        ...
        self.backbone = backbone.Darknet53spp()
    ...
    def modules_recurse(self, mod=None):
        ...
        for module in mod.children():
            if isinstance(module, (nn.ModuleList, nn.Sequential, backbone.Darknet53spp,
                                   backbone.Darknet53spp.custom_layers, head.Yolov3, head.Yolov3.custom_layers)):
