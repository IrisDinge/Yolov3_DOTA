...
class Xception(YoloABC):
    def __init__(self, num_classes=3, weights_file=None,
        ...
        self.head = head.Xception(num_classes, in_channels_list, num_anchors_list)
    ...
    def modules_recurse(self, mod=None):
        ...
        for module in mod.children():
            if isinstance(module, (nn.ModuleList, nn.Sequential, backbone.Xception, head.Xception)):
